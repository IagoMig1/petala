      ...
      <section className="bg-teal-700 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-teal-100 max-w-2xl mx-auto">
            Estou disponível para palestras, consultorias e parcerias. Ficarei
            feliz em responder suas dúvidas e discutir possíveis colaborações.
          </p>
        </div>
      </section>
      {/* Contact Section */}
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">CONVIVER, Taubaté - SP</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-teal-100 p-3 rounded-full mr-4">
                      <PhoneIcon size={24} className="text-teal-600" />
                    </div>
                    <div>
                      <h3 className="font-bold text-gray-800">Telefone</h3>
                      <p className="text-gray-600">(12) 9XXXX-XXXX</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-teal-100 p-3 rounded-full mr-4">
                      <MailIcon size={24} className="text-teal-600" />
                    </div>
                    <div>
                      <h3 className="font-bold text-gray-800">Email</h3>
                      <p className="text-gray-600">contato@petalacerda.com</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-teal-100 p-3 rounded-full mr-4">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Visite a CONVIVER – Associação Assistencial e Educacional para
              Pessoas com Necessidades em Taubaté, SP.
            </p>
          </div>
          <div className="h-96 bg-gray-300 rounded-lg shadow-md">
            {/* This is a placeholder for a map. In a real application, you would integrate with a mapping service like Google Maps */}
